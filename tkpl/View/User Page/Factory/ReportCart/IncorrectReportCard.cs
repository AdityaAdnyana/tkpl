...
{
    public class IncorrectReportCard : IReportCard
    {
        ...
        public IncorrectReportCard(string lessonTitle,string questionText, string answerText, string correctAnswerText)
        {
